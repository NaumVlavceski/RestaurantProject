...
function Tables() {
    ...
    return (
        <section id="tables" className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-6 sm:py-8 px-3 sm:px-6">
            <div className="max-w-7xl mx-auto">
                <div className="text-center grid grid-cols-2 sm:text-left mb-4 sm:mb-6">
                    <div>
                    ...
                    <div className="relative w-40 sm:w-72 md:w-96">
                        <svg
                            className="absolute left-3 top-6 -translate-y-1/2 h-5 w-5 text-gray-400"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
